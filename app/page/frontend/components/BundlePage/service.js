...
function create(values) {
    ...
    return fetch('/bundle/create/', opts).then(handleResponse)
}
...
function update(values) {
    ...
    return fetch('/bundle/update/', opts).then(handleResponse)
}
...
function remove(id) {
    ...
    return fetch('/bundle/remove/', opts).then(handleResponse)
}
